...
export const splitCreateBody = z.object({ receiptId: uuid.optional(), splitType: z.enum(['equal', 'percentage', 'custom', 'item_based']).optional(), participants: z.array(splitEntry).max(100).optional(), breakdown: z.array(splitEntry).max(100).optional(), name: z.string().trim().max(100).optional(), totalAmount: nonNegativeMoney.optional() });
